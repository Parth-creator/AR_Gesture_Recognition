...
def update():
    global pTime, plocX, plocY, pLen, cLen, pSize, cSize, rotOrient, rotIsChange
                ...
                if finger2[1] == 1 and finger2[2] == 1:
                    ...
                    if fingers[3] == 0 and finger2[3] == 0:
                        if fingers[4] == 0 and finger2[4] == 0:
                            ...
                            #         netSize = cSize - pSize
                            #         cube.scale = cube.scale * (netSize/sizeDiffer)
                            #         print(netSize)
                            #         pSize = cSize
                            cube.scale = length/50

            if fingers[1] == 1 and fingers[2] == 0:
                if finger2[1] == 1 and finger2[2] == 0:
